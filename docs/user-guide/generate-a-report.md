...
3. Everything in a report comes from PatchPilot's own data; generating one
...
4. Optionally turn on **AI narration** — a separate, additive toggle on
   ...
   [Production Deploy: AI features]({{ "/getting-started/production-deploy/#ai-features-optional" | relative_url }})
